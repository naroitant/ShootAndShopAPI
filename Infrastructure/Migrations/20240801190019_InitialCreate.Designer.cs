...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240801190019_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShootAndShopAPI.Domain.Entities.ActionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasDiscriminator().HasValue("ActionType");
            ...
            modelBuilder.Entity("ShootAndShopAPI.Domain.Entities.RifleActionType", b =>
                {
                    b.HasBaseType("ShootAndShopAPI.Domain.Entities.ActionType");

                    b.HasDiscriminator().HasValue("RifleActionType");
                });
            ...
            modelBuilder.Entity("ShootAndShopAPI.Domain.Entities.ShotgunActionType", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ShotgunActionType");
                });
            ...
            modelBuilder.Entity("ShootAndShopAPI.Domain.Entities.FireArm", b =>
                {
                    b.HasOne("ShootAndShopAPI.Domain.Entities.ActionType", "ActionType")
                        .WithMany()
